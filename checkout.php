...
<div class="container">
    ...
    <h2 class="bg-light p-2 text-center">جزئیات صورتحساب</h2>
    <form action="">
    <div class="row">
            <div class="col-lg-3">
                <label for="" class="form-label">نام و نام خانوادگی *</label>
                <input type="text" class="form-control">
                <label class="form-label" for="">شماره موبایل *</label>
                <input type="text" class="form-control">
                <p style="font-size: 12px;" class="text-danger">لطفا شماره‌ای وارد کنید که دارای تلگرام باشد.</p>
            </div>
        <div class="col-lg-3">
            <label class="form-label" for="">آدرس ایمیل *</label>
            <input type="text" class="form-control">
        </div>
        <div class="col-lg-6 text-center bg-light mb-2">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td class="text-muted">95,000 تومان</td>
                </tr>
                <tr>
                    <td>جمع جزء</td>
                    <td><small>95,000 تومان</small></td>
                </tr>
                <tr>
                    <td>هزینه واسطه فروشگاه</td>
                    <td><small>10,000 تومان</small></td>
                </tr>
                <tr>
                    <td><b>مبلغ قابل پرداخت</b></td>
                    <td><b>105,000 تومان</b></td>
                </tr>
                </tbody>
            </table>
            <button type="submit" href="" class="btn btn-success btn-lg" style="width: 200px;">پرداخت نهایی</button>
        </div>
        <div class="col-lg-6">
           <p class="lead">پس از کلیک روی دکمه <b>پرداخت نهایی</b> اطلاعات و سفارش شما ثبت می شود و به درگاه پرداخت منتقل می شوید.</p>
        </div>
        </div>
    </form>
