...
<div class="container">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link btn btn-info ms-5 text-center">
    ...
    <div class="row bg-light mt-2 mb-2">
        <h1 class="display-5 text-center">اعتماد شما، اعتبار ماست </h1>
        <p class="lead text-center">فقط در صورتی‌که اعتماد کامل به سایت کامیار اکانت دارید، اقدام به ثبت آگهی نمایید
            و در صورت تمایل به ثبت آگهی حتما صفحه شرایط و قوانین را مطالعه نمایید.</p>
    </div>
    <div class="row">
        <p class="lead">
            1. ثبت آگهی در سایت رایگان، ولی هر مبلغی که شما ثبت می‌کنید موقع فروش حق کمسیون سایت از آن مبلغ کسر خواهد شد.
            <br />
            2. کمسیون از هر دو طرف (خریدار و فروشنده) کسر می‌گردد.
        </p>
    </div>
    <div class="row">
        <div class="col-lg-3 col-sm-6 col-md-4 col-xs-12 text-center">
            <a href="sell-clash.php"><button style="width: 260px;" class="btn btn-secondary btn-lg mb-2">ثبت آگهی کلش اف کلنز</button></a>
        </div>
        <div class="col-lg-3 col-sm-6 col-md-4 col-xs-12 text-center">
            <a href="sell-pubg.php"><button style="width: 260px;" class="btn btn-danger btn-lg mb-2">ثبت آگهی پابجی</button></a>
        </div>
        <div class="col-lg-3 col-sm-6 col-md-4 col-xs-12 text-center">
            <a href="sell-callofduty.php"><button style="width: 260px;" class="btn btn-primary btn-lg mb-2">ثبت آگهی کالاف دیوتی</button></a>
        </div>
        <div class="col-lg-3 col-sm-6 col-md-4 col-xs-12 text-center">
            <a href="sell-freefire.php"><button style="width: 260px;" class="btn btn-info btn-lg mb-2">ثبت آگهی فری فایر</button></a>
        </div>
    </div>
    <div class="row">
        <table class="table table-striped table-responsive">
            ...
            <tbody>
            <tr>
                <td>از 0 تا 100 هزار تومن</td>
                <td>10 هزار تومن</td>
            </tr>
            <tr>
                <td>101 هزار تومن به بالا</td>
                <td>10% از کل مبلغ آگهی</td>
            </tr>
            </tbody>
        </table>
    </div>
    <div class="row">
        <p class="lead">
            1. برای از بین بردن کلاهبرداری، شماره شما به عنوان فروشنده در سایت و کانال نمایش داده نخواهد شد و
            فقط مدیران سایت شماره فروشندگان رو خواهند داشت.
            <br />
            2. در صورتی که اکانت بعد فروخته شدن مشکلی داشته باشد، کمسیون سایت را فروشنده پرداخت کرده و معامله کنسل می‌شود.
        </p>
    </div>
